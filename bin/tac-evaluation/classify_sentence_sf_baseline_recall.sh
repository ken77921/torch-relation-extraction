...
TUNED_PARAMS_USchema=${TH_RELEX_ROOT}/results/USchema_100d_more_data_baseline_15/2012-2015_recall_tune/params_t0.25_manual_tuned
...
TUNED_PARAMS_LSTM=${TH_RELEX_ROOT}/results/LSTM_USchema_org_more_data_sdrop_aug_15/2012-2015_recall_tune/params_t0.25_manual_tuned
