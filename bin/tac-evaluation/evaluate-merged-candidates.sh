...
#SCORED_CANDIDATES=$2
#TUNED_PARAMS=$3
THRESHOLD_CANDIDATE_1=$2
THRESHOLD_CANDIDATE_2=$3
OUT=$4
...
THRESHOLD_CANDIDATE=`mktemp`
cat $THRESHOLD_CANDIDATE_1 $THRESHOLD_CANDIDATE_2 > $THRESHOLD_CANDIDATE
...
echo "`$SCORE_SCRIPT $RESPONSE_PP $KEY | tee $OUT | grep -e F1 -e Recall -e Precision | tr '\n' '\t'`"
