...
${TH_RELEX_ROOT}/bin/tac-evaluation/score-tuned_for_kb_pipeline.sh $CANDIDATES $MODEL_LSTM $VOCAB_LSTM $GPU $MAX_SEQ $TUNED_PARAMS_LSTM $OUT_LSTM -dictionary $DICT_LOC
